...
/*
	...
	When filtering, the Button class takes into consideration all the other widgets that may have filtered the movies.
*/
...
private:
	...
	// This function is be called when the button is pressed to perform the action associated with the button.
